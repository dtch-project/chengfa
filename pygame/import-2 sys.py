...
while  True:
    ...
    screen.blit(pygame.transform.scale(rightimg, (100, 100)),(460,460))

    leftimg = pygame.image.load("C:\\Users\\Hannah\\Untitled-2\\left.png")
    screen.blit(pygame.transform.scale(leftimg, (100, 100)),(460,460))

    upimg = pygame.image.load("C:\\Users\\Hannah\\Untitled-2\\up.png")
    screen.blit(pygame.transform.scale(upimg, (100, 100)),(460,460))

    downimg = pygame.image.load("C:\\Users\\Hannah\\Untitled-2\\down.png")
    screen.blit(pygame.transform.scale(downimg, (100, 100)),(460,460))
